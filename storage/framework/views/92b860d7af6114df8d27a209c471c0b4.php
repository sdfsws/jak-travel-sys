    ...
    <div class="row">
        <div class="col-md-8 col-lg-6 mx-auto">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form method="POST" action="<?php echo e(route('subagent.services.store')); ?>" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row mb-3">
                            <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>" id="type" name="type" required>
                                    ...
                                    <option value="passport" <?php echo e(old('type') == 'passport' ? 'selected' : ''); ?>>جوازات</option>
                                    <option value="hotel" <?php echo e(old('type') == 'hotel' ? 'selected' : ''); ?>>فنادق</option>
                                    <option value="visa" <?php echo e(old('type') == 'visa' ? 'selected' : ''); ?>>تأشيرات</option>
...
unset($__errorArgs, $__bag); ?>" id="commission_rate" name="commission_rate" value="<?php echo e(old('commission_rate', 10)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                <div id="commission-example" class="form-text text-muted"></div>
                            </div>
                        </div>
                        <div class="mb-3">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateCommissionExample() {
            ...
            example.innerHTML = `مثال: العمولة على خدمة بقيمة ${price} ستكون ${commission} (${rate}%)`;
        }
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/mohammed/web/sys.jaksws.com/public_html/resources/views/subagent/services/create.blade.php ENDPATH**/ ?>